...
/**
 * A <code>HybrisConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link HybrisConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-07-31T02:51:08+10:00", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class HybrisConnectorLifecycleInjectionAdapter
    extends HybrisConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(HybrisConnectorLifecycleInjectionAdapter.class);
