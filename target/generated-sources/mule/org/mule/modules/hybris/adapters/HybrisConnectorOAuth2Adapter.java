...
package org.mule.modules.hybris.adapters;
...
import org.mule.modules.hybris.generated.adapters.HybrisConnectorCapabilitiesAdapter;
import org.mule.modules.hybris.generated.adapters.HybrisConnectorProcessAdapter;
...
/**
 * A {@code HybrisConnectorOAuth2Adapter} is a wrapper around {@link HybrisConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2018-07-31T02:51:08+10:00", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class HybrisConnectorOAuth2Adapter
    extends HybrisConnectorProcessAdapter
    implements OAuth2Adapter
{
    ...
    private final static Logger LOGGER = Logger.getLogger(HybrisConnectorOAuth2Adapter.class);

    public HybrisConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
